// color palette
const PRIMARY_NORMAL = '#eff2f5' //'#737373' //'#363b4e';
const PRIMARY_LIGHT = '#737373' //'#363b4e';
const SECONDARY_NORMAL = '#e05a47' //'#c4bbf0'
const INK_LIGHT = '#505568'
const INK_NORMAL = '#737373'
const CLOUD_NORMAL = '#eff2f5' //'#c4bbf0'
const CLOUD_DARK = '#e2e6ea' //'#737373' //'#e2e6ea';
...
export const THEME_LIGHT_MODE = {
  ...
  textPrimary: PRIMARY_LIGHT, //PRIMARY_NORMAL,
  ...COMMON_COLORS,
}
